...
#SBATCH --output=logs/modernbert.outtss
#SBATCH --error=logs/modernbert.errtss
...
model_dir=${HOME}/models/modernbert-two-stage-crux-researchy-${split}.b${bsz}_n${nsample}.${lr}.self
