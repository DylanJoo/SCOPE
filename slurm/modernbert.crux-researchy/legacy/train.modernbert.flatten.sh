...
split=flatten
max_length=512
model_dir=${HOME}/models/modernbert-crux-researchy-${split}.${bsz}_n${nsample}.${lr}.${max_length}.cls
...
srun singularity exec $SIF \
    ...
    --run_name modernbert-base.crux-researchy-${split}.b${bsz}_n${nsample}.${lr}.${max_length}.cls
