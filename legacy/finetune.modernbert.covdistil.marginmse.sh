...
#SBATCH --output=logs/modernbert.out.%am
#SBATCH --error=logs/modernbert.err.%am
...
model_dir=${HOME}/models/modernbert-crux-researchy-${split}.agg-$AGG.covdistil-marginmse.$LAMBDA
